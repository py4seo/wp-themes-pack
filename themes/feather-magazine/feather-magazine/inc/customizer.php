...
function feather_magazine_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'show_readmore_btn', array(
        'default' => 0,
        'sanitize_callback' => 'wp_kses',
    ) );

    $wp_customize->add_control( 'show_readmore_btn', array(
        'label'    => __( 'Show Read More Button', 'feather-magazine' ),
        'section'  => 'all_blog_posts',
        'priority' => 1,
        'settings' => 'show_readmore_btn',
        'type'     => 'checkbox',
    ) );
