...
class ThemePageController
{
    ...
    public static function ThemePageSubMenu()
    {
        ...
        add_submenu_page('themes.php', __('Theme Settings', 'feather-magazine'), __('Theme Settings', 'feather-magazine') . $awaiting, 'manage_options', self::GetPageSlug(), array(__CLASS__, 'ThemePageContent'), 1);
    }
