...
class TemplateInformationController
{
    ...
    public static function InformationContent()
    {
        ...
        add_action('admin_footer', function () {
            $theme = wp_get_theme();
            $text = is_child_theme() ? sprintf(__("Unlock all features by upgrading to the premium edition of %s and its parent theme %s.", 'feather-magazine'), $theme, wp_get_theme($theme->Template)) : sprintf(__("Unlock all features by upgrading to the premium edition of %s.", 'feather-magazine'), $theme);
?>
            <script type="text/template" id="tmpl-superbthemes-js-information-wrapper">
                <div class="superbthemes-js-information-wrapper">
                    <div class="superbthemes-js-information-item">
                        ...
                        <div class="superbthemes-js-information-item-header"><?php esc_html_e("Upgrade to premium", 'feather-magazine'); ?></div>
                        <div class="superbthemes-js-information-item-content">
                            <p><?php echo esc_html($text); ?></p>
                            <a href="<?php echo esc_url(self::$ThemeLink."?su_source=blocks_patterns"); ?>" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", 'feather-magazine'); ?></a>
                        </div>
                    </div>
                </div>
            </script>
