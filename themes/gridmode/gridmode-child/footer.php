...
<?php else : ?>
    <p>Copyright &copy; 2015 - <?php echo date('Y'); ?> | All rights reserved by <a href="<?php echo esc_url(home_url('/')); ?>"><?php bloginfo('name'); ?></a></p>
<?php endif; ?>
<p class='gridmode-credit'><a href="<?php echo esc_url( '' ); ?>"><?php /* translators: %s: Theme author. */ printf( esc_html__( '', '' ), '' ); ?></a></p>
</div>
