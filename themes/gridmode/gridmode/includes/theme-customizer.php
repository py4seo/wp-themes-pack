...
function gridmode_register_theme_customizer( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'gridmode_options[header_image_alt_text]', array( 'default' => get_bloginfo( 'name' ), 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'sanitize_text_field', ) );

    $wp_customize->add_control( 'gridmode_header_image_alt_text_control', array( 'label' => esc_html__( 'Header Image Alt Text', 'gridmode' ), 'section' => 'header_image', 'settings' => 'gridmode_options[header_image_alt_text]', 'type' => 'text', ) );
    ...
    $wp_customize->add_setting( 'gridmode_options[hide_static_page_title]', array( 'default' => false, 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'gridmode_sanitize_checkbox', ) );

    $wp_customize->add_control( 'gridmode_hide_static_page_title_control', array( 'label' => esc_html__( 'Hide Page Header from Static Homepage', 'gridmode' ), 'section' => 'gridmode_section_page', 'settings' => 'gridmode_options[hide_static_page_title]', 'type' => 'checkbox', ) );

    $wp_customize->add_setting( 'gridmode_options[hide_static_page_meta]', array( 'default' => false, 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'gridmode_sanitize_checkbox', ) );

    $wp_customize->add_control( 'gridmode_hide_static_page_meta_control', array( 'label' => esc_html__( 'Hide Page Meta Data (Page Date, Page Author, Comment Link) from Static Homepage', 'gridmode' ), 'section' => 'gridmode_section_page', 'settings' => 'gridmode_options[hide_static_page_meta]', 'type' => 'checkbox', ) );
    ...
    $wp_customize->add_setting( 'gridmode_options[threadslink]', array( 'default' => '', 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'esc_url_raw' ) );

    $wp_customize->add_control( 'gridmode_threadslink_control', array( 'label' => esc_html__( 'Threads URL', 'gridmode' ), 'section' => 'gridmode_section_social', 'settings' => 'gridmode_options[threadslink]', 'type' => 'text' ) );
    ...
    $wp_customize->add_setting( 'gridmode_options[mastodonlink]', array( 'default' => '', 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'esc_url_raw' ) );

    $wp_customize->add_control( 'gridmode_mastodonlink_control', array( 'label' => esc_html__( 'Mastodon URL', 'gridmode' ), 'section' => 'gridmode_section_social', 'settings' => 'gridmode_options[mastodonlink]', 'type' => 'text' ) );
