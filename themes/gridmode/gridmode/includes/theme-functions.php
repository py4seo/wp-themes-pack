...
<div class='gridmode-social-icons'>
    ...
    <?php if ( gridmode_get_option('threadslink') ) : ?>
            <a href="<?php echo esc_url( gridmode_get_option('threadslink') ); ?>" target="_blank" rel="nofollow" class="gridmode-header-social-icon-threads" aria-label="<?php esc_attr_e('Threads Button','gridmode'); ?>"><i class="fab fa-threads" aria-hidden="true" title="<?php esc_attr_e('Threads','gridmode'); ?>"></i></a><?php endif; ?>
    ...
    <?php if ( gridmode_get_option('mastodonlink') ) : ?>
            <a href="<?php echo esc_url( gridmode_get_option('mastodonlink') ); ?>" target="_blank" rel="nofollow" class="gridmode-header-social-icon-mastodon" aria-label="<?php esc_attr_e('Mastodon Button','gridmode'); ?>"><i class="fab fa-mastodon" aria-hidden="true" title="<?php esc_attr_e('Mastodon','gridmode'); ?>"></i></a><?php endif; ?>
...
function gridmode_page_postmeta() { ?>
    ...
    <?php if ( !((is_front_page()) && (gridmode_get_option('hide_static_page_meta'))) ) { ?>
    <div class="gridmode-entry-meta-single">
...
function gridmode_header_image_alt_text() {
    $header_image_alt_text = get_bloginfo( 'name' );

    if ( gridmode_get_option('header_image_alt_text') ) {
        $header_image_alt_text = gridmode_get_option('header_image_alt_text');
    }

    return apply_filters( 'gridmode_header_image_alt_text', $header_image_alt_text );
}

function gridmode_header_image_markup() {
    if ( get_header_image() ) {
        if ( gridmode_get_option('remove_header_image_link') ) {
            the_header_image_tag( array( 'class' => 'gridmode-header-img', 'alt' => esc_attr( gridmode_header_image_alt_text() ) ) );
        } else { ?>
            <a href="<?php echo esc_url( gridmode_header_image_destination() ); ?>" rel="home" class="gridmode-header-img-link"><?php the_header_image_tag( array( 'class' => 'gridmode-header-img', 'alt' => esc_attr( gridmode_header_image_alt_text() ) ) ); ?></a>
        <?php }
    }
}
