...
<div class="gridmode-box-inside">
    ...
    <?php if ( !((is_front_page()) && (gridmode_get_option('hide_static_page_title'))) ) { ?>
    ...
    <div class="entry-content gridmode-clearfix">
            ...
            wp_link_pages( array(
             'before'      => '<div class="gridmode-clearfix"></div><div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'gridmode' ) . '</span>',
             'after'       => '</div>',
             'link_before' => '<span>',
             'link_after'  => '</span>',
             ) );
